...
auto trefoil_tangent = +[](const double t) -> coord3d {
...
auto lemniscate_tangent = +[](const double t) -> coord3d {
  const double a = 2.0;
  const double b = 0.3;
...
auto curve35_tangent = +[](const double t) -> coord3d {
...
public:
  ...
  auto get_shape_tan(int c) const {
    switch (c) {
      ...
      case 3:
        return trefoil_tangent;
      case 4:
        return lemniscate_tangent;
      case 5:
        return curve35_tangent;
      default:
        cerr << "invalid curve chosen, aborting ..." << endl;
        __builtin_unreachable();
        break;
